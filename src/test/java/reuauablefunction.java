...
public class reuauablefunction {
    public static void launchapplication(String url) {
         WebDriverManager.chromedriver().setup();
     driver_script.driver=new ChromeDriver();

        driver_script.driver.get(url);
    ...
    public static void closebrowser() {
        driver_script.driver.close();
    }

    public static void vtigerlogin(String vusername, String vpassword) {

        //driver_script.driver.findElement(By.name(driver_script.prop.getProperty("username"))).sendKeys(vusername);
        driver_script.driver.findElement(By.name("user_name")).clear();

        driver_script.driver.findElement(By.name("user_name")).sendKeys(vusername);
        driver_script.driver.findElement(By.name("user_password")).clear();
        driver_script.driver.findElement(By.name(("user_password"))).sendKeys(vpassword);
        driver_script.driver.findElement(By.name("Login")).click();
